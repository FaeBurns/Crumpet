...
public class WhileStatementNode : NonTerminalNode, INonTerminalNodeFactory, IInstructionProvider
{
    ...
    private IEnumerable GetLoopInstructions()
    {
        ...
        // start of loop label
        yield return new LabelInstruction(conditionLabel, Location) { FriendlyName = "While Condition" };
        ...
        yield return new LabelInstruction(exitLabel, Location) { FriendlyName = "While Exit" };
    }
}